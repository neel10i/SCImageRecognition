...
a connection between the Flask application and the MySQL database. Frontend will consist of pure HTML/JS/CSS rather than 
a framework due to time contrainsts. 
```
